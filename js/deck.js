...
(function () {
  ...
  const SECTION_RANGES = [
    ...
    { idx: 2, slides: [4, 5, 6] },
    { idx: 3, slides: [7, 8, 9] },
    { idx: 4, slides: [10, 11, 12] },
    { idx: 5, slides: [13] },
    { idx: 6, slides: [14] },
    { idx: 7, slides: [15] },
  ];

  const TOTAL_LOGICAL = 14;
  let currentIdx = 0;
  ...
  (function setupFgcModal() {
    ...
    const DATA = {
      'event-night': {
        ...
        title: 'Event Night',
        desc: 'Lottoland at the centre of fight night — money-can\'t-buy fan experiences and guaranteed PFL star power that put the brand face-to-face with fans at every event.',
        videos: [
          {
            src: 'assets/video/event/meet_greet', label: 'Fighter Meet & Greet',
            vdesc: 'Money-can\'t-buy access for fans and competition winners — signings, photos and face time with PFL stars, delivered as Lottoland-branded experiences.'
          },
          {
      ...
      'fight-highlights': {
        ...
        clickToPlay: true,
        desc: 'Automated, broadcast-quality highlight packages cut within minutes of every PFL fight — delivered to Lottoland to repurpose across owned channels, driving engagement and excitement around every event. All powered by WSC Sports.',
        videos: [
          {
      ...
      'content-series': {
        ...
        desc: 'Episodic, story-led content following fighters through camp, fight week and beyond — a recurring series that keeps Lottoland front and centre between events.',
        series: [
          {
  ...
  (function setupWatchBetPlayer() {
    const frame = document.querySelector('[data-slide="11"] .wb-frame');
    if (!frame) return;
